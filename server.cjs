...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Student Services Coordination Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Student Service Cases";
process.env.TABLE_NAME = process.env.TABLE_NAME || "student_service_cases_records";
'use strict';
